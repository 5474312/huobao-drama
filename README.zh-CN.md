...
**⬇️ 预编译安装包下载：[国内镜像（腾讯云，推荐）](https://installer.chatfire.site/huobao-drama/v4.0.2/) · [GitHub Releases（海外）](https://github.com/chatfire-AI/huobao-drama/releases/latest)**

| 平台 | 下载文件 |
|---|---|
| macOS（Apple Silicon，M 系列） | `HuobaoDrama-4.0.2-arm64.dmg` |
